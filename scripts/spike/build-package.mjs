...
import { canonicalize, sha256Hex, listPayloadFiles, readManifest, fingerprintOf } from './package-ops.mjs';
...
// canonicalization with signature = null. package.integrity is never listed.
...
const privateKey = createPrivateKey(fs.readFileSync(path.join(keysDir, 'dev-ed25519-private.pem'), 'utf8'));
