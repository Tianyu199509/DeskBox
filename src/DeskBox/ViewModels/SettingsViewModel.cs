...
public partial class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    private string _selectedWidgetCollapsedStyle = SettingsService.WidgetCollapsedStyleSmart;
...
private int _selectedWeatherRefreshInterval = 60;
    ...
    private string[]? _cachedWidgetCollapsedStyleDisplayNames;
...
[ObservableProperty] private bool _weatherShowPressure;
        ...
        IAppUpdateService? appUpdateService = null)
    {
        ...
        _selectedWidgetCollapsedStyle = SettingsService.NormalizeWidgetCollapsedStyle(settings.WidgetCollapsedStyle);
