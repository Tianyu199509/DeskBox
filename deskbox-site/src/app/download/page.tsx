    ...
    <div className="pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="fluent-card text-center mb-12">
          ...
          <a href="https://github.com/Tianyu199509/DeskBox/releases/download/v1.1.4/DeskBox_Setup_1.1.4_x64.exe" className="fluent-button fluent-button-primary-shimmer text-lg px-8 py-3 inline-block">下载 x64 安装包</a>
        </motion.div>
